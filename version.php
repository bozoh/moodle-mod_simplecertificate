...
// The current module version (Date: YYYYMMDDXX where XX is moodle version)
$plugin->version  = 2015013027;  
$plugin->requires = 2014041100;  // Requires this Moodle version (moodle 2.7.x)
